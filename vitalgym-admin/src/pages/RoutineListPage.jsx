...
import { faPenToSquare as faPenToSquareRegular, faTrashCan as faTrashCanRegular, faPlus } from '@fortawesome/free-solid-svg-icons';
...
export default function RoutineListPage() {
  ...
  return (
    <div className="container-xl mt-4">
      <NavBar />
      <h2 className="mt-4 mb-3">📋 Rutinas creadas</h2>

      <div className="mb-4 d-flex justify-content-start">
        <Link to="/rutinas/crear" className="btn btn-success">
